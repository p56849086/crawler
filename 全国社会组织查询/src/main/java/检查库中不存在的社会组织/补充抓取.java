...
public class 补充抓取 {
    public static void main(String[] args) {
        MongoCollection<Document> sourse = new MongoClient("192.168.1.175", 27017).getDatabase("organization_data").getCollection("缺少的社会组织");
        Document query = new Document("_id", new Document("$gte","1052997_52230129MJY2562344"));
